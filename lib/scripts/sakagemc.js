...
//   HUBOT_SAKAGEMC_FLICKR_USER_ID
//   HUBOT_SAKAGEMC_FLICKR_ACCESS_TOKEN
//   HUBOT_SAKAGEMC_FLICKR_ACCESS_TOKEN_SECRET
//
// Commands:
...
var Loader = function() {
  ...
  this._authOptions = {
    ...
    user_id:             process.env.HUBOT_SAKAGEMC_FLICKR_USER_ID,
    access_token:        process.env.HUBOT_SAKAGEMC_FLICKR_ACCESS_TOKEN,
    access_token_secret: process.env.HUBOT_SAKAGEMC_FLICKR_ACCESS_TOKEN_SECRET
  };
};

Loader.prototype._authenticate = function() {
  var deferred = q.defer();
  Flickr.authenticate(this._authOptions, function(err, flickr) {
    if (err) {
      deferred.reject(err);
    } else {
      this.flickr = flickr;
